...
public class CheckApprovalDayComplete {
	...
	public Optional<ApprovalDayComplete> checkApprovalDayComplete(String employeeId, DatePeriod date){
		...
		List<ApproveRootStatusForEmpImport> appRoots = approvalStatusAdapter.getApprovalByListEmplAndListApprovalRecordDateNew(toListDate(date), Arrays.asList(employeeId));
