...
public class Scenario1Case4 extends Kmw003Common {
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kmw003/Scenario1Case4";
        this.init();
        employeeCode = "020905";
        password = "Jinjikoi5";
    ...
    public void test() throws Exception {
        ...
        setValueGrid(2, 5, "1.0");
        setValueGrid(3, 5, "2.0");
