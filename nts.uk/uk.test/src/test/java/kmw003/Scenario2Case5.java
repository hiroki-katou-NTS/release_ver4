...
public class Scenario2Case5 extends Kmw003Common {
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kmw003/Scenario2Case5";
        this.init();
        employeeCode = "020905";
        password = "Jinjikoi5";
    ...
    public void test() throws Exception {
        ...
        setValueGrid(2, 5, "4.0");
        setValueGrid(2, 4, "14.0");
