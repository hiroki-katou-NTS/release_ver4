...
public class Scenario1Case5 extends Kmw003Common {
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kmw003/Scenario1Case5";
        this.init();
        employeeCode = "020905";
        password = "Jinjikoi5";
    ...
    public void test() throws Exception {
        ...
        setValueGrid(3, 4, "9.0");
        setValueGrid(3, 5, "3.0");
