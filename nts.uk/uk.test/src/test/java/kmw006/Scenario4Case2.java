...
public class Scenario4Case2 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kmw006/Scenario4Case2";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("inpMonth")).sendKeys("2020/07");
        ...
        driver.findElement(By.id("recDatePicker")).sendKeys("2020/07/04");
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//input[@id='absDatePicker']")).sendKeys("2020/07/02");
        ...
        driver.findElement(By.xpath("//input[contains(@id,'startInput')]")).sendKeys("2020/07/02");
        driver.findElement(By.xpath("//input[contains(@id,'endInput')]")).clear();
        driver.findElement(By.xpath("//input[contains(@id,'endInput')]")).sendKeys("2020/07/04");
        ...
        WaitPageLoad();
        driver.findElement(By.id("singleDate")).clear();
        driver.findElement(By.id("singleDate")).sendKeys("2020/07/02");
        // WaitElementLoad(By.xpath("//textarea[@id='inpReasonTextarea']"));
        driver.findElement(By.xpath("//textarea[@id='inpReasonTextarea']")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//textarea[@id='inpReasonTextarea']")).clear();
        driver.findElement(By.xpath("//textarea[@id='inpReasonTextarea']")).sendKeys("autotest");
        WaitElementLoad(By.xpath("//span[@class='box']"));
        WebElement checkbox1 = driver.findElement(By.xpath("//span[@class='box']"));
        if (!checkbox1.isSelected()) {
            checkbox1.click();
        }
        driver.findElement(By.xpath("//button[@class='proceed']")).click();
        WaitElementLoad(By.xpath("//button[@class='large']"));
        String msgactual1 = driver.findElement(By.id("ui-id-4")).findElement(By.className("control")).getText();
        if(msgexpected.equals(msgactual1)){
            screenShot();
        }
        driver.findElement(By.xpath("//button[@class='large']")).click();
        WaitElementLoad(By.xpath("//div[contains(@class,'ui-icon-caret-1-s')]"));
        ...
        List<WebElement> listEl1 =
        driver.findElements(By.xpath("//td[contains(.,'010207')]"));
        WebElement el1 = listEl1.get(listEl1.size() - 1);
        el1.findElements(By.xpath("preceding-sibling::td")).get(0).click();
