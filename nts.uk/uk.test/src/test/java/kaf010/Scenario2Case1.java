...
public class Scenario2Case1 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kaf010/Scenario2Case1";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        inputdate.clear();
        inputdate.set(2019, 11, 14);
        i = setDateKaf010(inputdate, screenshotFile, i);
        TestRoot.folder =   new File(screenshotPath);
        this.uploadTestLink(149, 33);
    }
    ...
    public int setDateKaf010(Calendar inputdate, File screenshotFile, int count) throws Exception{
        ...
        //load cmm/045/a
        login(screenshotFile, "016976", "Jinjikoi5", count);
        WaitPageLoad();
        ...
        WaitPageLoad();
        //js.executeScript("$('#grid1_container [type = " + "checkbox" + "]')" + " .each(function(data) {$(this)[0].checked = true})");
        ...
        //count++;
        login(screenshotFile, "025445", "Jinjikoi5", count);
