...
public class Scenario1Case2 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/ksu007/Scenario1Case2";
        this.init();
    }
    ...
    public void testCase2() throws Exception {
        ...
        WaitElementLoad(By.xpath("//li[@data-value='030EF900-1730']"));
        driver.findElement(By.xpath("//li[@data-value='030EF900-1730']")).click();
        threadSleep(100);
        driver.findElement(By.xpath(".//*[@id='extable']/div[5]/table/tbody/tr[10]/td[8]")).click();
        driver.findElement(By.xpath(".//*[@id='extable']/div[5]/table/tbody/tr[11]/td[8]")).click();
        ...
        WaitPageLoad();
        screenShot();
        // 個人スケジュール一括修正にて、職場＋勤務種別（EF)で社員を抽出
        ...
        driver.findElements(By.className("ntsSearchBox")).get(4).sendKeys("0120");
        ...
        driver.findElements(By.xpath("//th[@role='rowheader']")).get(90).click();
        driver.findElements(By.xpath("//th[@role='rowheader']")).get(91).click();
        ...
        threadSleep(100);
        driver.findElement(By.xpath("//table[@id='day-list-tbl']/tbody/tr[@data-id='030']")).click();
        threadSleep(100);
        ...
        threadSleep(100);
        driver.findElement(By.id("ccg001-input-code")).sendKeys("026056");
        ...
        driver.findElement(By.id("ccg001-input-code")).sendKeys("027218");
        driver.findElement(By.xpath(".//*[@id='ccg001-part-g']/div[1]/button")).click();
        WaitPageLoad();
        driver.findElement(By.id("ccg001-btn-KCP005-apply")).click();
        WaitPageLoad();
