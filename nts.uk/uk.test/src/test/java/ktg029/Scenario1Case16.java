...
public class Scenario1Case16 extends Kdw003Common {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/ktg029/Scenario1Case16";
        this.init();
    }
...
// 1.16
        ...
        driver.findElement(By.id("COM1000000000000000CS00057IS00621")).click();
        ...
        js.executeScript("$('.ui-igcombo-list').scrollTop($('.ui-igcombo-list')[0].scrollHeight)");
        WaitPageLoad();
        driver.findElement(By.xpath("//li[@data-value='132']")).click();
        WaitPageLoad();
