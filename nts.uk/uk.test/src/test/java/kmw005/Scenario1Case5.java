...
public class Scenario1Case5 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kmw005/Scenario1Case5";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        driver.findElement(By.xpath("//*[@id='dpGrid']/div[3]/table/tbody/tr[2]/td[2]")).click();
        WaitPageLoad();
        screenShotFull();
        driver.findElement(By.xpath("//*[@id='contents-area']/div[2]/div[1]/div[2]/button[2]")).click();
        WaitPageLoad();
        screenShotFull();
        // done case1-3
