...
public class Scenario14Case10 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case10";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad(); 
        selectItemKdw003_2("勤務種類", "12/03(火)").click();
        Thread.sleep(2000);
        driver.switchTo().frame("window_1");
        WaitElementLoad(By.xpath("//tr[@data-id = '100']"));      
