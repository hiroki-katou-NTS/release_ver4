...
public class Scenario14Case7 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case7";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();  
        js.executeScript("$('#contents-area').scrollTop(100)");
        js.executeScript("$('.mgrid-free').scrollTop(200)");  

        selectItemKdw003_2("勤務種類", "11/11(月)").click();
        Thread.sleep(2000);
        driver.switchTo().frame("window_1");
        WaitElementLoad(By.xpath("//tr[@data-id = '009']"));      
        driver.findElement(By.xpath("//tr[@data-id = '009']")).click();  
