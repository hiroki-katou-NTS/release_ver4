...
public class Scenario14Case6 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case6";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("勤務種類", "11/14(木)").click();
        selectItemKdw003_1("勤務種類", "11/14(木)").click();
        selectItemKdw003_1("勤務種類", "11/14(木)").findElement(By.xpath("./div/input")).sendKeys("002");         
