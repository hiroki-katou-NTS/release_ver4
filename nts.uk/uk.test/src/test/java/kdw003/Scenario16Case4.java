...
public class Scenario16Case4 extends Kdw003Common {
    private Integer i=1;
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario16Case4";
        this.initDefault();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        setValueGrid(13, 7, "093");
        WaitPageLoad();
        setValueGrid(16, 9, "010");
        WaitPageLoad();
        setValueGrid(16, 7, "094");
        ...
        driver.findElement(By.xpath("//div[@id='vacationRemaining-content']//tr[2]/td[1]")).click();
        
        WebElement dialogInfo = driver.findElement(By.xpath("//iframe[contains(@name,'window_" + i + "')]"));
        driver.switchTo().frame(dialogInfo);
        
        WaitPageLoad();
        screenShot();
        
        this.uploadTestLink(1064, 268);
    }
