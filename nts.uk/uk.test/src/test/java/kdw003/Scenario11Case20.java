...
public class Scenario11Case20 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case20";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("recDatePicker")).sendKeys("2019/11/17");

        WaitPageLoad();
        driver.findElement(By.id("absDatePicker")).click();
        driver.findElement(By.id("absDatePicker")).clear();
        driver.findElement(By.id("absDatePicker")).sendKeys("2019/11/18");
