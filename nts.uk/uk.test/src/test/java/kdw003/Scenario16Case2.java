...
public class Scenario16Case2 extends Kdw003Common {
    private Integer i=1;
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario16Case2";
        this.initDefault();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        setValueGrid(4, 7, "900");
        WaitPageLoad();
        setValueGrid(3, 7, "147");
        ...
        driver.findElement(By.xpath("//div[@id='vacationRemaining-content']//tr[2]/td[2]")).click();
