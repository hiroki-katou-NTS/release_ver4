...
public class Scenario14Case13 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case13";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        Thread.sleep(2000);
        driver.switchTo().frame("window_1");
        WaitElementLoad(By.xpath("//tr[@data-id = '102']"));      
        driver.findElement(By.xpath("//tr[@data-id = '102']")).click();  
