...
public class Scenario11Case21 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case21";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("recDatePicker")).sendKeys("2019/11/23");

        WaitPageLoad();
        driver.findElement(By.xpath("//body")).click();
        driver.findElement(By.id("absDatePicker")).clear();
        WaitElementLoad(By.id("absDatePicker"));
        driver.findElement(By.id("absDatePicker")).sendKeys("2019/11/22");
