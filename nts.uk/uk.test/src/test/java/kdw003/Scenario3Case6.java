...
public class Scenario3Case6 extends Kdw003Common {
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw/003/Scenario3/Case6";
        this.initDefault();
    }
    ...
    public void test() throws Exception {
        ...
        driver.get(kdw003);
        WaitPageLoad();
        Calendar inputStartDate1 = Calendar.getInstance();
        inputStartDate1.set(2019, 10, 1);
        Calendar inputEndDate1 = Calendar.getInstance();
        inputEndDate1.set(2019, 10, 30);

        extractData(inputStartDate1, inputEndDate1);
        ...
        driver.get(kmw003);
        WaitPageLoad();
        if(!checkedBox("本人", employeeCode, 1)){
            clickCheckBox("本人", employeeCode, 1);
        } 
        WaitElementLoad(By.xpath("//button[@class='proceed']"));
        driver.findElement(By.xpath("//button[@class='proceed']")).click();
        WaitPageLoad();
        ...
        checkBoxSize = driver.findElements(By.xpath("//table[@class ='mgrid-fixed-table']/tbody/tr")).size();
