...
public class Scenario11Case5 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case5";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("inputdate")).sendKeys("2019/11/06");
