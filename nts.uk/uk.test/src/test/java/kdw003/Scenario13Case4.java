...
public class Scenario13Case4 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario13Case4";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("退勤時刻1", "11/05(火)").click();
        selectItemKdw003_1("退勤時刻1", "11/05(火)").findElement(By.xpath("./div/input")).sendKeys("17:30");         
        WaitPageLoad();
        selectItemKdw003_1("休憩開始時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩開始時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩開始時刻2", "11/05(火)").findElement(By.xpath("./div/input")).sendKeys("18:00");       
        WaitElementLoad(By.xpath("//body"));
        driver.findElement(By.xpath("//body")).click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").findElement(By.xpath("./div/input")).sendKeys("18:15");       
        WaitElementLoad(By.xpath("//body"));
        driver.findElement(By.xpath("//body")).click();
