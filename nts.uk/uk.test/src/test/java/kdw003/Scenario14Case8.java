...
public class Scenario14Case8 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case8";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("勤務種類", "11/12(火)").click();
        selectItemKdw003_1("勤務種類", "11/12(火)").click();
        selectItemKdw003_1("勤務種類", "11/12(火)").findElement(By.xpath("./div/input")).sendKeys("009");         
