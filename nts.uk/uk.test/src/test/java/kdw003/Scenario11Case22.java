...
public class Scenario11Case22 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case22";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("recDatePicker")).sendKeys("2019/11/24");

        WaitPageLoad();
        driver.findElement(By.id("absDatePicker")).click();
        driver.findElement(By.id("absDatePicker")).clear();
        WaitElementLoad(By.id("absDatePicker"));
        driver.findElement(By.id("absDatePicker")).sendKeys("2019/11/21");

        WaitPageLoad();
        driver.findElement(By.id("reasonCombo")).click();

        WaitPageLoad();
        WaitElementLoad(By.xpath("//body//div[@class = 'ui-igcombo-list']//li[2]"));
        driver.findElement(By.xpath("//body//div[@class = 'ui-igcombo-list']//li[2]")).click();
