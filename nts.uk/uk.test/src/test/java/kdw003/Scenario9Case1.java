...
public class Scenario9Case1 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario9Case1";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        setValueGrid(12, 7, "8:40");
        Thread.sleep(1000);
        setValueGrid(12, 8, "19:30");
        Thread.sleep(1000);
        setValueGrid(12, 13, "18:20");
        Thread.sleep(700);
