...
public class Scenario4Case6 extends TestRoot {
    ...
    public void test() throws Exception {
        ...
        //対象締め変更
        WaitElementLoad(By.xpath("/html/body/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div/div[1]/div[1]/div[1]/div[2]/div/div/div[2]"));
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div/div[1]/div[1]/div[1]/div[2]/div/div/div[2]")).click();
        WaitElementLoad(By.xpath("//li[contains(.,'10日締め')]"));	
        driver.findElement(By.xpath("//li[contains(.,'10日締め')]")).click();
        
        WaitElementLoad(By.id("ccg001-input-code"));
        driver.findElement(By.id("ccg001-input-code")).sendKeys("025094");
