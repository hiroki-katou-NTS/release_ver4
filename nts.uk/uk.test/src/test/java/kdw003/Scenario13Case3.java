...
public class Scenario13Case3 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario13Case3";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("休憩開始時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩開始時刻2", "11/05(火)").findElement(By.xpath("./div/input")).clear();
        WaitElementLoad(By.xpath("//body"));
        driver.findElement(By.xpath("//body")).click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").click();
        selectItemKdw003_1("休憩終了時刻2", "11/05(火)").findElement(By.xpath("./div/input")).clear();
        WaitElementLoad(By.xpath("//body"));
        driver.findElement(By.xpath("//body")).click();
        WaitElementLoad(By.xpath("//button[@class='proceed']"));
        driver.findElement(By.xpath("//button[@class='proceed']")).click();
