...
public class Scenario14Case4 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case4";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        js.executeScript("$('.mgrid-free').scrollTop(100)");  

        selectItemKdw003_2("勤務種類", "11/12(火)").click();
        Thread.sleep(2000);
        driver.switchTo().frame("window_1");
