...
public class Scenario14Case9 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case9";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("勤務種類", "11/13(水)").click();
        selectItemKdw003_1("勤務種類", "11/13(水)").click();
        selectItemKdw003_1("勤務種類", "11/13(水)").findElement(By.xpath("./div/input")).sendKeys("002");         
