...
public class Scenario11Case15 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case15";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("inputdate")).sendKeys("2019/11/17");
        ...
        driver.findElement(By.id("inpEndTime1")).sendKeys("当日16:00");
