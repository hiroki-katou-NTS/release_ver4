...
public class Scenario14Case17 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case17";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad(); 
        selectItemKdw003_1("勤務種類", "12/13(金)").click();
        selectItemKdw003_1("勤務種類", "12/13(金)").click();
        selectItemKdw003_1("勤務種類", "12/13(金)").findElement(By.xpath("./div/input")).sendKeys("092");         
