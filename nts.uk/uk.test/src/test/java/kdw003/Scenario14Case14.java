...
public class Scenario14Case14 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case14";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("勤務種類", "12/03(火)").click();
        selectItemKdw003_1("勤務種類", "12/03(火)").findElement(By.xpath("./div/input")).sendKeys("102");         
