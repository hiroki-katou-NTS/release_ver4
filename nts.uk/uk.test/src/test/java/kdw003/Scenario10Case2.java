...
public class Scenario10Case2 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario10Case2";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        setValueGrid(6, 11, "12:50");
        Thread.sleep(1000);
        setValueGrid(6, 12, "18:05");
        Thread.sleep(1000);
        setValueGrid(6, 13, "18:23");
        Thread.sleep(700);
