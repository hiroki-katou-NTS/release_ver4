...
public class Scenario14Case18 extends TestRoot {

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario14Case18";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        selectItemKdw003_1("勤務種類", "12/14(土)").click();
        selectItemKdw003_1("勤務種類", "12/14(土)").click();
        selectItemKdw003_1("勤務種類", "12/14(土)").findElement(By.xpath("./div/input")).sendKeys("002");         
