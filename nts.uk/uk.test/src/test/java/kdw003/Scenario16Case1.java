...
public class Scenario16Case1 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario16Case1";
        this.initDefault();
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        setValueGrid(4, 7, "021");
        WaitPageLoad();
        setValueGrid(3, 7, "102");
        WaitPageLoad();
        setValueGrid(8, 7, "002");
        ...
        driver.findElement(By.xpath("//div[@id='vacationRemaining-content']//tr[1]/td[2]")).click();

        WebElement dialogInfor = driver.findElement(By.xpath("//iframe[contains(@name,'window_" + i + "')]"));
        driver.switchTo().frame(dialogInfor);

        WaitPageLoad();
        driver.findElement(By.xpath("//div[@id='employeeInfo']")).click();
        
        WaitPageLoad();
        screenShot();

        this.uploadTestLink(1055, 265);
    }
