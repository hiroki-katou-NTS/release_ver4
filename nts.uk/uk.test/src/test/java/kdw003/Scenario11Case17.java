...
public class Scenario11Case17 extends Kdw003Common {
    private Integer i = 1;

    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kdw003/Scenario11Case17";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("singleDate")).sendKeys("2019/11/5");
