...
public class Scenario2Case1 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kaf005/Scenario2Case1";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.id("inpStartTime1")).sendKeys("当日7:00");
        driver.findElement(By.id("inpEndTime1")).click();
        driver.findElement(By.id("inpEndTime1")).clear();
        driver.findElement(By.id("inpEndTime1")).sendKeys("当日17:00");
        ...
        WaitPageLoad();
        List<WebElement> listEl = driver.findElements(By.xpath("//td[contains(.,'025497')]"));
        ...
        driver.findElement(By.xpath("//button[@tabindex='6']")).click();
        WaitPageLoad();
        List<WebElement> listEl2 = driver.findElements(By.xpath("//td[contains(.,'025497')]"));
