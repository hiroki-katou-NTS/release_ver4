...
public class Scenario4Case2 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kaf005/Scenario4Case2";
        this.init();
    }
    ...
    public void test() throws Exception {
        ...
        driver.findElement(By.xpath("//input[@name='menu']")).sendKeys("2");
        ...
        driver.findElement(By.xpath("//input[@name='starttime']")).sendKeys("480");
        driver.findElement(By.xpath("//input[@name='endtime']")).clear();
        driver.findElement(By.xpath("//input[@name='endtime']")).sendKeys("1200");
