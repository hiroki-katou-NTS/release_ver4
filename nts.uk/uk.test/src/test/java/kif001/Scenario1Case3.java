...
public class Scenario1Case3 extends TestRoot {
    ...
    public void setUp() throws Exception {
        screenshotPath = "images/kif001/Scenario1Case3";
        robot = new Robot();
        this.init();   
    }
    ...
    public void test() throws Exception {
        ...
        WaitPageLoad();
        js.executeScript("$($('.mgrid-free')[1]).scrollLeft($(\"td:contains('PCログオフ乖離時間')\").offset().left - $($('.mgrid-free')[1]).offset().left - $($('.mgrid-free')[1]).width() + 200)");
        screenShot();
        ...
        WaitPageLoad();
        driver.findElement(By.xpath("//button[@data-value=13 and contains(.,'即時実行')]")).click();
        WaitPageLoad();
        Thread.sleep(120000);
        screenShot();
        driver.findElement(By.xpath("//button[@data-value=13 and contains(.,'終了')]")).click();
        WaitPageLoad();
        ...
        driver.get(domain + "nts.uk.at.web/view/kbt/002/f/index.xhtml");
        WaitPageLoad();
        driver.findElement(By.xpath("//button[@data-value=13 and contains(.,'詳細')]")).click();
        WaitPageLoad();
        screenShot();
