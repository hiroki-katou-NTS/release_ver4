...
public class Scenario2Case1 extends Kaf006Common{
    @BeforeEach
    public void setUp() throws Exception {
        screenshotPath = "images/kaf006/Scenario2Case1";
        this.init();
        employeeCode = "025497";
        password = "Jinjikoi5";
    ...
    public void test() throws Exception {
        ...
        //cmm045 approval
        //015310
        login(screenshotFile, "015310", password);
        driver.get(cmm045);
        WaitPageLoad();
